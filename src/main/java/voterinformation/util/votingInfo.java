...
public class votingInfo {
    ...
    **/
    public static Map getInfo(){
        Map<String, String> map = new HashMap();
        map.put("Candidate","The Democratic candidate for governor in the state of Florida is Andrew Gillum. Current polls suggest that he has approximately 70% chance to win the upcoming election.");
        ...
        map.put("Judge", "Jamey Moody and Robin Fuson are the judicial candidates for Floridas 13th circuit.");
        return map;
    }
    ...
    public static Map getInfo2(){
        ...
        map.put("Judge", "According to his website, Jamey Moody is a Hillsborough County native with a long family history of upholding the law. Jamey graduated from the University of Florida with a Bachelor of Science in Finance and a Juris Doctor from University of Floridas Levin College of Law. His entire career has been spent in Circuit Court, where he has practiced law as a local attorney and partner.");
        return map;
    }
    ...
    public static Map getImages(){
        ...
        map.put("Amendment3", "http://www.trbimg.com/img-5bc7abdf/turbine/os-maxwell-amendment-3/300/300x169");
        map.put("Judge", "http://2.bp.blogspot.com/-hy_Q-9ydGOc/UxAN8a77YaI/AAAAAAAAABM/9dEqA95EkXI/s1600/circuit+court.jpg");
        return map;
    }
